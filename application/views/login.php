		...
		<div class="container top-search-main">
			<div class="row">
				<div class="ts-menu">
					<!--SECTION: LOGO-->
					<div class="ts-menu-1">
						<a href="index-1.html"><img src="<?php echo base_url('assets/images/aff-logo.png'); ?>" alt=""> </a>
					</div>
	...
	<section class="tz-register">
			<div class="log-in-pop">
				...
				<div class="log-in-pop-right">
					<a href="#" class="pop-close" data-dismiss="modal"><img src="<?php echo base_url('assets/images/cancel.html'); ?>" alt="" />
					</a>
					<h4>Login</h4>
					<p>Don't have an account? Create your account. It's take less then a minutes</p>
